...
const AlphaDogs = () => {
  const { balance, loadingTwo, setLoadingTwo, checker, setChecker, loading } =
    useUser();
      ...
      {loading ? (
        ...
        <Animate>
          <div className="w-full flex justify-center flex-col px-4">
            <div
              id="refer"
              className="w-full h-screen pt-5 scroller space-y-3 overflow-y-auto pb-[180px]"
            >
              {loadingTwo && (
              ...
              >
                <div className="w-full h-[60px] overflow-hidden rounded-[12px] bg-btn flex items-center justify-center text-center font-semibold relative">
                  ...
                  <img
                    src="/scorebg.svg"
                    alt="ifd"
                    className="object-cover object-center w-[400px] h-[220px] absolute left-[6px] mt-[-10px] right-0"
                  />
                  ...
                  <div className="relative flex items-center justify-center text-white space-x-2">
                    <img
                      ...
                      className="w-[20px]"
                    />
                    <span>{process.env.REACT_APP_PROJECT_NAME_SMALL}</span>
                  </div>
                </div>
                ...
                <div className="w-full flex justify-center bg-[#181818] rounded-[12px] relative overflow-hidden">
                  <img
                    src="/svg.svg"
                    alt="ifd"
                    className="object-cover absolute left-0 w-full right-0 h-[200px] object-center rounded-[12px]"
                  />
                  ...
                  <div className="w-full relative flex flex-col px-6 pt-6 items-center">
                    ...
                    <p className="pb-6 text-black font-bold">💰MCATS</p>

                    <div className="w-full pb-4">
                      <NavLink
                        to="/airdrop"
                        className="bg-btn h-[50px] px-4 rounded-[10px] flex items-center justify-center space-x-1 font-semibold text-[15px]"
                      >
                        <img
                          src="/tons.svg"
                          alt="dfd"
              ...
              {checker && (
                ...
                >
                  <div className="w-full flex h-full taskbg mt-[2px] justify-center relative flex-col items-center px-4">
                      ...
                      <div className="w-full h-full relative pb-24 flex items-center justify-center flex-col space-y-3">
                        ...
                        <div className="absolute bottom-10 flex flex-col w-full justify-center items-center space-y-5">
                          <p className="w-full text-center max-w-[20em]">
                            Welcome to{" "}
                            {process.env.REACT_APP_PROJECT_NAME_SMALL}!<br />{" "}
                            Start mining{" "}
                            {process.env.REACT_APP_PROJECT_NAME_SMALL} tokens
                            today!
                          </p>
                          {balance > 0 ? (
                            <button
                              onClick={() => setChecker(false)}
                              className="w-full py-3 rounded-[8px] font-semibold px-3 flex items-center justify-center text-center bg-btn"
                            >
                              Let's go!
                            </button>
                          ) : (
                    ...
                    {checking && <NewUser setChecker={setChecker} />}
                  </div>
                </div>
              )}
            </div>
